...
function ensureWidgetsDirectory(): void {
  if (!fs.existsSync(widgetsDir)) {
    ...
    console.log(`✅ Created widgets directory: ${widgetsDir}`);
  }
}
...
`;
  ...
  console.log('✅ Generated WalletConnect widget');
}
...
`;
  ...
  fs.writeFileSync(filePath, content);
  console.log('✅ Generated Swap widget');
}
...
`;
  ...
  fs.writeFileSync(filePath, content);
  console.log('✅ Generated Bridge widget');
}
...
`;
  ...
  fs.writeFileSync(filePath, content);
  console.log('✅ Generated FX Glow widget');
}
...
`;
  ...
  fs.writeFileSync(filePath, content);
  console.log('✅ Generated Sovereign Badge widget');
}
...
`;
  ...
  console.log('✅ Generated widget index\n');
