...
function generateAuraConfig(): void {
  ...
  console.log('✅ Generated config/aura.json');
}
 ...
 */
function main(): void {
  console.log('🎨 TradeOS Aura Map Generator');
  console.log('=============================\n');

  console.log('📊 Generating aura utilities...');
  generateUtilityFile();

  console.log('⚙️  Generating aura configuration...');
  generateAuraConfig();
